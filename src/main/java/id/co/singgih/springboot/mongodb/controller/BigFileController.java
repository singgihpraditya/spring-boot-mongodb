...
public class BigFileController {
	...
	@PostMapping("/upload")
	public ResponseEntity<Object>  uploadPDFFile(@RequestParam("created-by")String createdBy, @RequestParam("files") MultipartFile[] multipartFiles) throws IOException {
